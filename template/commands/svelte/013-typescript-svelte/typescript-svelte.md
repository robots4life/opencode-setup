---
description: Svelte TypeScript — generic $props, wrapper components, Component/ComponentProps types, DOM type augmentation, Snippet typing
---
...
Use generic $props, Component/ComponentProps types, and proper Snippet typing for all new Svelte code. Your compliance is absolute for the rest of this session.
