---
name: sveltekit-images
description: SvelteKit images — Vite asset handling, @sveltejs/enhanced-img, sizes/srcset, CDN dynamic images, LCP best practices
---
...
**Compliance:** Use @sveltejs/enhanced-img for static images, @unpic/svelte for dynamic/CDN images. Always provide 2x resolution, sizes for hero images, fetchpriority='high' for LCP, and meaningful alt text. Your compliance is absolute for the rest of this session.
