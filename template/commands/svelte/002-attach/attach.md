---
description: Svelte 5.29+ {@attach ...} — the modern replacement for use:action, fully reactive element attachments
---
...
Prefer `{@attach ...}` over `use:` actions in new Svelte 5 code.
